...
const StatusCard = ({ title, count, status }) => {
    ...
    const getStatusIcon = (status) => {
        switch (status) {
            case 'preparing': return <FaUtensils className="text-yellow-600" />;
            case 'ready_for_pickup': return <FaClock className="text-blue-600" />;
            case 'out_for_delivery': return <MdDeliveryDining className="text-orange-600 text-xl" />;
