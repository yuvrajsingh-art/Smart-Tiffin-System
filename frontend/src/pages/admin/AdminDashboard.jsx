                        ...
                        <div className="bg-white rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl relative z-10 flex flex-col max-h-[85vh]">
                            ...
                            <div className="flex-1 overflow-y-auto p-4 space-y-2">
                                {stats.activityLogs.length === 0 ? (
                                    ...
                                    <div key={i} className="flex items-center gap-4 p-3 bg-gray-50 hover:bg-white border border-transparent hover:border-gray-100 rounded-xl transition-all group">
                                        <div className={`size-10 rounded-lg flex items-center justify-center ${log.color} bg-opacity-10 shadow-sm`}>
                                        ...
                                        <span className="material-symbols-outlined text-gray-300 text-[16px]">check_circle</span>
                                    </div>
                                ))}
                            </div>
                        </div>
